#ifndef _CRC_CLIENT_SELECT_HPP_
#define _CRC_CLIENT_SELECT_HPP_

#include "../common/include/crc_work_select_client.hpp"

class CRCClientSelect : public CRCWorkSelectClient
{
public:
	CRCClientSelect()
	{
